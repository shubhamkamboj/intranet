...
INSERT INTO `class_room` VALUES (1,'Class-1'),(2,'Class-2'),(3,'Class-3'),(4,'Class-4'),(5,'Class-5');
...
CREATE TABLE `fees` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKryr4bth09yasab333kivrjbav` (`student_id`),
...
INSERT INTO `parent` VALUES (1,'Arvind','8923598798','Noida');
...
CREATE TABLE `student` (
  ...
  `phone` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK3b5tt0fijrs22iefupqtw4397` (`class_room_id`),
  KEY `FKqqq09m02bgrk47qoe6fs3ht4w` (`parent_id`),
  KEY `FKj1c0de75pterue04btw6w5mh8` (`section_id`),
  CONSTRAINT `FK3b5tt0fijrs22iefupqtw4397` FOREIGN KEY (`class_room_id`) REFERENCES `class_room` (`id`),
...
-- Dump completed on 2025-08-03 15:32:42
